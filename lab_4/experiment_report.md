...
簡易PBO、つまりISで最良だった戦略がOOS順位73〜144位へ落ちた割合は50%未満でした。ただし、PBOが低いだけで将来の収益性が保証されるわけではありません。別期間のHoldout、WFO、DryRun、コスト・スリッページ再評価が必要です。
